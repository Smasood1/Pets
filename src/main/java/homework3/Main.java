...
public class Main {
    ...
    public static void letAnimalsEat() {
        ...
        //create loop that asks for what type of pet the animal is.
        //use if statements to check if it matches any of the child classes and make new objects
        //from those child classes if true
